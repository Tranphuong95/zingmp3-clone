      ...
      <div className={styles["authfy-container"]}>
        ...
        <div className={styles['authfy-panel__right']}>
          <div className={styles["authfy-login"]}>
            {/* panel login start */}
            <LoginPage showForm={showForm} setShowForm={setShowForm} data={loginFormData} setLoginFormData={setLoginFormData}/>
            {/* panel signup start */}
            <SignupPage showForm={showForm} setShowForm={setShowForm} data={signupFormData} setSignupFormData={setSignupFormData}/>
            {/* panel forgot start */}
